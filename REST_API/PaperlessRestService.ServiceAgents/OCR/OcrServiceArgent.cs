...
namespace PaperlessRestService.ServiceAgents.OCR;

public class OcrServiceArgent : IOcrServiceArgent
{
    private readonly string tessDataPath;
    private readonly string language;

    public OcrServiceArgent(IOptions<OcrOptions> options)
    {
        tessDataPath = options.Value.TessDataPath;
