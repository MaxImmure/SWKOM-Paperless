...
{
    public class RabbitmqQueueReceiver : RabbitmqQueueClient, IQueueReceiver
    {
        public event EventHandler<QueueReceivedEventArgs> OnReceived;

        private EventingBasicConsumer _consumer;
        private readonly ILogger<RabbitmqQueueReceiver> _logger;

        public RabbitmqQueueReceiver(IOptions<RabbitmqQueueOptions> options, ILogger<RabbitmqQueueReceiver> logger) : base(options.Value.ConnectionString, options.Value.QueueName)
        {
